...
key_item_ram_data = {1000	: [['80', 0x4A, 'ON'], ['20', 0x67, 'OFF'], ['01', 0x68, 'ON']],  # Walse Tower Key
                1001	: [['40', 0x4A, 'ON']], # Steamship Key
                1002	: [['20', 0x4A, 'ON'], ['03', 0x39, 'ON'],], # Ifrits Fire
                1003	: [['10', 0x4A, 'ON'],['08', 0x1B, 'ON'],], # SandWormBait
                1004	: [['08', 0x4A, 'ON']], # Big Bridge Key
                1005	: [['04', 0x4A, 'ON'],['2C', 0xE5, ''],['00', 0xE6, ''],['AC', 0xE7, ''],['A5', 0xE8, ''],], # Hiryuu Call
                1006	: [['02', 0x4A, 'ON'],['30', 0xE9, ''],['00', 0xEA, ''],['AD', 0xEB, ''],['A5', 0xEC, ''],], # Submarine Key
                1007	: [['01', 0x4A, 'ON'],['40', 0x1F, 'OFF'],], # Anti Barrier
                1008	: [['80', 0x4B, 'ON'],['20', 0x3C, 'ON'],], # Bracelet
                1009	: [['10', 0x4B, 'ON']], # PyramidPage
                1010	: [['08', 0x4B, 'ON']], # Shrine Page
                1011	: [['04', 0x4B, 'ON']], # Trench Page
                1012	: [['02', 0x4B, 'ON']], # Falls Page
                1013	: [['20', 0x4C, 'ON']], # Mirage Radar
                1014	: [['04', 0x4C, 'ON'],['04', 0x53, 'ON'],['01', 0xAF, 'ON'],], # Adamantite
                1015	: [['02', 0x4C, 'ON'],['10', 0x39, 'ON'],], # Moogle Suit
                1016	: [['80', 0x4D, 'ON'],['02', 0x22, 'ON'],], # Elder Branch
                1017	: [['20', 0x4D, 'ON'],['08', 0x24, 'ON'],], # 1st Tablet
                1018	: [['10', 0x4D, 'ON'],['40', 0x25, 'ON'],], # 2nd Tablet
                1019	: [['08', 0x4D, 'ON'],['02', 0x26, 'ON'],], # 3rd Tablet
                1020	: [['04', 0x4D, 'ON'],['08', 0x26, 'ON'],], # 4th Tablet
                }
