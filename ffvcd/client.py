...
class FFVCDSNIClient(SNIClient):
    ...
    async def validate_rom(self, ctx):
        ...
        rom_name = await snes_read(ctx, FFVCD_ROMNAME_START, ROMHASH_SIZE)
        # if rom_name is None or rom_name != b'FINAL FANTASY 5      ':
    ...
    async def game_watcher(self, ctx):
        print("Game watcher FFVCD")
        from SNIClient import snes_buffered_write, snes_flush_writes, snes_read
        # print("Game WATCH")
        # FFVCD_TODO: Handle Deathlink
