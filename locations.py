...
LocationData("Mua - Brave Blade (Brave Blade)", address = 0xC0FB28, area = "Mua", location_type="event"),
LocationData("Mua - Chicken Knife (Chicken Knife)", address = 0xC0FB2A, area = "Mua", location_type="event"),
